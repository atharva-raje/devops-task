...
### Deploying and testing the Application
    ...
    5.there are 2 lambda files in the sample application the lambda(awsconsole) file is for when input message is in json format and the lambda file is for when message is in string format so based on create the zip file of the revalant file and specify that file in the lambda creation code in terrform file
